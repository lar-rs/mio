...
impl From<&str> for IType {
    fn from(value: &str) -> Self {
        match value {
            ...
            "fluid"           => IType::Fluid,
            "lamp"            => IType::Lamp,
            "gearpump"        => IType::GearPump,
            "impulspump"      => IType::ImpulsPump,
...
impl fmt::Display for IType {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match *self {
            ...
            IType::GearPump   => return write!(f,"gearpump"),         
            IType::ImpulsPump => return write!(f,"impulspump"),           
            ...
            IType::Method     => return write!(f,"method"),
